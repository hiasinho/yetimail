...
ColumnLayout {
    ...
    required property bool listLoading
    ...
    RowLayout {
        ...
        MailButton { objectName: "readerAskAgent"; iconText: view.icons.agent; tooltipText: view.agentLaunching ? "Opening your configured AI agent…" : view.agentEnabled ? "Open your configured AI agent with a Himalaya reference to this email" : "Ask agent is available for loaded, non-demo messages"; enabled: view.agentEnabled; onClicked: view.askAgentRequested() }
    ...
    ScrollView {
        ...
        TextArea {
            ...
            text: view.reading ? "Loading message…" : view.readError ? view.readError : view.message ?
                ...
                view.messageCount > 0 ? "Loading message…" : view.listLoading ? "Loading " + view.folderName + "…" :
                view.listError ? "" : "Nothing to do.\n\nYou're all caught up."
